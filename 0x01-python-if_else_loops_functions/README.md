...
3. rite a program that prints the ASCII alphabet, in lowercase, not followed by a new line.
...
14.i program that prints the ASCII alphabet, in reverse order, alternating lowercase and uppercase (z in lowercase and Y in uppercase) , not followed by a new line.
